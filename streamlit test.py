...
# Plugged in your exact live Supabase connection strings
URL = "https://uyrfrgdjwfthmwyhvdrj.supabase.co".strip()
KEY = "sb_publishable_1EmUVN4ONUX-2dnEY-eFZg_GzYA06mw".strip()

# Initialize the cloud database client safely
try:
...
if not supabase:
    st.warning("Please configure valid database keys above to display live stock sheets.")
else:
    try:
